...
export default function PlayerForm({ onPlayersSubmit, gameHistory }: PlayerFormProps) {
                    ...
                    <div className="relative z-10 flex flex-col items-center space-y-6 p-10 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 shadow-xl w-full">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-md">
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-white/80">Jugador 1 (X)</label>
                                <input
                                    type="text"
                                    value={player1}
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-white/80">Jugador 2 (O)</label>
                                <input
                                    type="text"
                                    value={player2}
